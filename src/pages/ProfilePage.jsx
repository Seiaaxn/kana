        ...
        return (
            <div className="min-h-screen bg-dark-bg pb-20">
                ...
                <div className="flex flex-col items-center justify-center px-6 pt-20 pb-10">
                    ...
                    <h2 className="text-base font-semibold text-white mb-1">Belum masuk</h2>
                    <p className="text-xs text-gray-500 text-center mb-8 max-w-xs">
                        Masuk atau daftar untuk menyimpan daftar tontonan, komentar, dan preferensimu.
                    </p>
                    ...
                    <div className="mt-10 w-full max-w-xs space-y-3">
                        {[
                            { icon: Heart, label: 'Simpan anime favoritmu ke My List' },
                            { icon: BookOpen, label: 'Tulis komentar di episode' },
                            { icon: Bell, label: 'Aktifkan notifikasi anime baru' },
                        ].map(({ icon: Icon, label }) => (
            ...
            <div className="px-4 py-6">
                        ...
                        {editing ? (
                            <div className="flex items-center gap-2">
                                <input
                                    ...
                                    maxLength={20}
                                />
                                <button onClick={handleSave} className="p-1.5 bg-primary-400/20 text-primary-400 rounded-lg hover:bg-primary-400/30 transition-colors">
                                    <Check size={14} />
                                </button>
                                <button onClick={handleCancel} className="p-1.5 bg-white/5 text-gray-500 rounded-lg hover:bg-white/10 transition-colors">
                                    <X size={14} />
                                </button>
                            </div>
                        ) : (
                ...
                <div className="space-y-2 mb-6">
                    ...
                    <div className="flex items-center gap-3 bg-dark-card rounded-xl px-4 py-3 border border-white/5">
                        ...
                        <div className="flex-1 min-w-0">
                            <p className="text-[10px] text-gray-600 mb-0.5">Bergabung sejak</p>
                ...
                <div className="space-y-2">
                    <button
                        ...
                        className="w-full flex items-center gap-3 bg-dark-card rounded-xl px-4 py-3 border border-white/5 hover:border-white/10 transition-colors"
                    >
                ...
                <div className="mt-8">
                    <button
                        onClick={() => setShowLogoutConfirm(true)}
                        className="w-full flex items-center justify-center gap-2 border border-red-500/20 text-red-400 text-sm font-medium py-2.5 rounded-xl hover:bg-red-500/8 transition-colors"
                    >
                        <LogOut size={15} />
                        Keluar dari akun
                    </button>
            ...
            {showLogoutConfirm && (
                <div className="fixed inset-0 z-50 flex items-end justify-center bg-black/60 backdrop-blur-sm pb-6 px-4">
                    <div className="w-full max-w-sm bg-dark-surface border border-white/8 rounded-2xl p-5 animate-slide-up">
                        <h3 className="text-sm font-semibold text-white mb-1">Yakin mau keluar?</h3>
                        <p className="text-xs text-gray-500 mb-4">Kamu harus masuk lagi untuk mengakses fitur personalisasi.</p>
                        <div className="flex gap-2">
                            <button
                                onClick={() => setShowLogoutConfirm(false)}
                                className="flex-1 py-2.5 text-sm font-medium text-gray-400 bg-dark-card rounded-xl hover:bg-white/5 transition-colors"
                            >
                                Batal
                            </button>
                            <button
                                onClick={handleLogout}
                                className="flex-1 py-2.5 text-sm font-semibold text-white bg-red-500/80 rounded-xl hover:bg-red-500 transition-colors"
                            >
                                Keluar
                            </button>
                        </div>
